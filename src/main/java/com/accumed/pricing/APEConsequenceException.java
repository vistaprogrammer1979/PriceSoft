 ...
 * @author smutlak
 */
public class APEConsequenceException extends RuntimeException {
private final WorkingMemory workingMemory;
private final Activation activation;

public APEConsequenceException(final Activation activation, final WorkingMemory workingMemory, final Throwable exception) {
    super(exception);
